            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
                {/* 1st section */}
                 <div>
                    ...
                    <p className='text-gray-400 mb-4'>Discover the latest trends in fashion and lifestyle products. Quality meets style at Aether.</p>
             ...
             <div className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-400">
               <p>&copy; {new Date().getFullYear()} Aether -- [By : Hritik] All rights reserved.</p>
             </div>
        </div>     
    </footer>
  )
